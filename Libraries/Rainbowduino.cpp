...
void Rainbowduino::draw_C(unsigned int z)
{
...
void Rainbowduino::draw_O(unsigned int z)
{
    int i;
...
void Rainbowduino::draw_N(unsigned int z)
{
    int i;
    delay(50);
...
void Rainbowduino::draw_N2(unsigned int z)
{
    int i;
    delay(50);
    for(i=0;i<4;i++) {Rb.setPixelZXY(i,0,3,RED[z],GREEN[z],BLUE[z]);}
...
void Rainbowduino::draw_O2(unsigned int z)
{
    int i;
    delay(50);
    for(i=0;i<4;i++) {Rb.setPixelZXY(0,i,3,RED[z],GREEN[z],BLUE[z]);}
...
void Rainbowduino::draw_R(unsigned int z)
{
    int i;
    delay(50);
    for(i=0;i<4;i++) {Rb.setPixelZXY(i,0,3,RED[z],GREEN[z],BLUE[z]);}
