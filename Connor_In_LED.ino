...
//Y plane goes away from me 0 1 2 3
  ...
  delay(100);
  for(i=1;i<4;i++){Rb.setPixelZXY(0,i,2,RED[z],GREEN[z],BLUE[z]);}
...
//Start of O 
  ...
  for(i=0;i<4;i++){
    Rb.setPixelZXY(0,i,0,RED[z],GREEN[z],BLUE[z]);
  }
  delay(100);
  for(i=0;i<4;i++){
    Rb.setPixelZXY(0,i,1,RED[z],GREEN[z],BLUE[z]); 
  }
  
  delay(100);
  for(i=0;i<4;i++){
    Rb.setPixelZXY(0,i,2,RED[z],GREEN[z],BLUE[z]); 
  }
  delay(100);
  for(i=1;i<4;i++){
   Rb.setPixelZXY(0,i,2,RED[z],GREEN[z],BLUE[z]); 
  ...
  delay(100);
  for(i=0;i<4;i++){
    Rb.setPixelZXY(0,i,3,RED[z],GREEN[z],BLUE[z]);
  }
  delay(100);
  for(i=1;i<4;i++){
    Rb.setPixelZXY(i,0,0,RED[z],GREEN[z],BLUE[z]);
  }
  for(i=1;i<4;i++){
      Rb.setPixelZXY(i,0,1,RED[z],GREEN[z],BLUE[z]);
  } 
  delay(100);
  for(i=1;i<4;i++){
      Rb.setPixelZXY(i,0,2,RED[z],GREEN[z],BLUE[z]);
  }
  delay(100);
  for(i=1;i<4;i++){
      Rb.setPixelZXY(i,0,3,RED[z],GREEN[z],BLUE[z]);
  }
  delay(100);
  for(i=1;i<4;i++){
      Rb.setPixelZXY(3,i,3,RED[z],GREEN[z],BLUE[z]);
  }
  
  delay(100);
  for(i=1;i<4;i++){
      Rb.setPixelZXY(3,i,2,RED[z],GREEN[z],BLUE[z]);
  }
  
  delay(100);
  for(i=1;i<4;i++){
      Rb.setPixelZXY(3,i,1,RED[z],GREEN[z],BLUE[z]);
  }
  
  delay(100);
  for(i=1;i<4;i++){
      Rb.setPixelZXY(3,i,0,RED[z],GREEN[z],BLUE[z]);
  }
...
// START OF RIGHT SIDE
  ...
  delay(100);
  for(i=0;i<4;i++){
      Rb.setPixelZXY(i,3,0,RED[z],GREEN[z],BLUE[z]);
  }
  delay(100);
  for(i=0;i<4;i++){
      Rb.setPixelZXY(i,3,1,RED[z],GREEN[z],BLUE[z]);
  }
  
  delay(100);
  for(i=0;i<4;i++){
      Rb.setPixelZXY(i,3,2,RED[z],GREEN[z],BLUE[z]);
  }
  delay(100);
  for(i=0;i<4;i++){
      Rb.setPixelZXY(i,3,3,RED[z],GREEN[z],BLUE[z]);
  }
